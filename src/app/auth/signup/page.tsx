      ...
      >
        ...
        <div className="rounded-3xl border border-lightGray bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <Label htmlFor="confirm" className="mb-1.5 block text-sm font-medium text-navy">
                Confirm Password
              </Label>
              <div className="relative">
                <Input
            ...
            <div className="flex items-start gap-2">
              <Checkbox
                ...
                className="mt-0.5"
              />
              <Label htmlFor="terms" className="text-sm text-mediumGray cursor-pointer">
                I agree to the{" "}
                <Link href="/terms" className="text-electricBlue hover:underline">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-electricBlue hover:underline">
                  Privacy Policy
                </Link>
              </Label>
            </div>
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-mediumGray">or</span>
            <Separator className="flex-1" />
          </div>

          <div className="space-y-3">
            <Button variant="outline" className="w-full" size="lg" type="button" onClick={() => { window.location.href = "/api/auth/signin/google"; }}>
            ...
            <Button variant="outline" className="w-full" size="lg" type="button" onClick={() => { window.location.href = "/api/auth/signin/github"; }}>
